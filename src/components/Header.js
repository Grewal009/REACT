...
const Header = () => {
  ...
  const normalLink = "";
  const activeLink =
    "underline underline-offset-8 decoration-lime-600 decoration-4";
          ...
          <div className="flex justify-between items-center ">
            ...
            <div className="hidden  sm:flex sm:justify-start">
              <ul className="flex">
                ...
                >
                  <li className="mx-2 py-1 text-lg font-bold text-gray-600 hover:text-black">
                    HOME
                  </li>
                </NavLink>
                ...
                >
                  ...
                  <li className="mx-2 pr-2 py-1 text-lg font-bold  text-gray-600 hover:text-black">
            ...
            <div className="sm:hidden">
              ...
              >
                ...
                <p className="mt-[2px] text-lg font-bold  text-gray-600 hover:text-black">
                  <span>{cartItems?.length} </span>Cart
                </p>
              </NavLink>
            </div>
            ...
            <div
              className={
                !nav
                  ? "hidden"
                  : "sm:hidden absolute top-0 left-0 w-full h-screen bg-slate-100 z-10"
              }
            >
              <ul className="h-screen flex flex-col justify-center items-center">
                ...
                >
                  <li className="mx-2 py-2 text-4xl font-bold text-gray-600 hover:text-black">
                    HOME
                  </li>
                </NavLink>
